...
void APU::writeRegisters(uint8_t reg, uint8_t value)
{
    switch (reg)
    {
        ...
        case 0x00:
            ...
            squareChannel1.lengthCounterHalt_EnvelopeLoop = (value & 0x20);
        ...
        case 0x04:
            ...
            squareChannel2.lengthCounterHalt_EnvelopeLoop = (value & 0x20);
        ...
        case 0x15:
            control = value;
            squareChannel1.enabled = (control & 0x01);
            
            if (!squareChannel1.enabled)
                squareChannel1.lengthCounter = 0;
            squareChannel2.enabled = (control & 0x02);
            if (!squareChannel2.enabled)
                squareChannel2.lengthCounter = 0;
            triangleChannel.enabled = (control & 0x04);
            if (!triangleChannel.enabled)
